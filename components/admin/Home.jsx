...
export default function AdminHome() {
  ...
  return (
    <motion.div
      className="bg-gray-900 min-h-screen w-full text-white p-4"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-400 mt-1 text-sm">Welcome back, {session?.user?.name || "Admin"} 👋</p>
        </div>
        <img
      ...
      >
        <StatCard title="Total Stores" value="15" icon={<FaStore size={32} />} color="text-purple-400" />
        <StatCard title="Products" value="320" icon={<FaBox size={32} />} color="text-yellow-400" />
        <StatCard title="Customers" value="1200" icon={<FaUsers size={32} />} color="text-green-400" />
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="bg-gray-700 p-6 rounded-xl flex flex-col">
            <h3 className="text-lg font-semibold text-gray-300 mb-1">Revenue This Month</h3>
            <p className="text-3xl font-bold text-green-400">$12,400</p>
          </div>

          <div className="bg-gray-700 p-6 rounded-xl flex flex-col">
            <h3 className="text-lg font-semibold text-gray-300 mb-1">New Customers</h3>
